...
import { FileSignature, Search, Building2, MapPin, DollarSign, Calendar, CheckCircle, XCircle, ArrowRight, Loader2 } from 'lucide-react';
      ...
      <AnimatePresence mode="wait">
        ...
        {screen === 'lookup' && (
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400">Enter your email or phone number to securely review your Traveler Assignment Confirmation.</p>
            </div>

            <form onSubmit={handleLookup} className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 p-8 rounded-3xl shadow-2xl">
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-950/50 border border-slate-700/50 rounded-xl py-4 pl-12 pr-4 text-white focus:outline-none focus:border-indigo-500 transition-colors"
                    required
                  />
                </div>
              </div>
              ...
              <button 
                ...
                className="w-full mt-8 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-indigo-500/20 disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2"
              >
                {isSearching ? (
        ...
        {screen === 'review' && (
          ...
          >
            ...
            <div className="w-full lg:w-[420px] bg-slate-900 p-8 lg:p-10 flex flex-col border-l border-slate-800 justify-between overflow-y-auto">
              <div>
              ...
              <div className="mt-12 space-y-4">
                  ...
                  className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-indigo-500/20 flex justify-center items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-indigo-600"
                >
                  {isProcessing ? (
